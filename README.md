...
- [helmfile](https://helmfile.readthedocs.io/en/latest/#installation) v0.14 or higher  
...
### Step 4: Uninstall
```bash
curl -L https://raw.githubusercontent.com/deislabs/ratify/main/helmfile.yaml | helmfile destroy -f - 
```
